    ...
    return [
      {
        ...
        destination: '/recursos/notas/:slug/',
        permanent: true,
      },
      { source: '/category/:path*', destination: '/recursos/notas/', permanent: true },
      { source: '/tag/:path*', destination: '/recursos/notas/', permanent: true },
      { source: '/blog/:path*', destination: '/recursos/notas/', permanent: true },
      { source: '/portfolios/:path*', destination: '/recursos/notas/', permanent: true },
      { source: '/news/:path*', destination: '/recursos/notas/', permanent: true },
